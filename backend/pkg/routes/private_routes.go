...
func PrivateRoutes(a *fiber.App, jwtMiddleware func(*fiber.Ctx) error, auth *controllers.AuthController, token *controllers.TokenController, walletController *controllers.WalletController) {
	// Create routes group.

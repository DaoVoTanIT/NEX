...
func GetTasks(c *fiber.Ctx) error {
	resp, err := (&services.DefaultTaskService{}).GetTasks()
	if err != nil {
...
func GetTask(c *fiber.Ctx) error {
	resp, err := (&services.DefaultTaskService{}).GetTask(c.Params("id"))
	if err != nil {
		return c.Status(500).JSON(core.Error(500, "internal error", err.Error(), nil))
	}
	return c.Status(resp.Code).JSON(resp)
...
func CreateTask(c *fiber.Ctx) error {
	...
	resp, err := (&services.DefaultTaskService{}).Create(c.Context(), c, req)
	if err != nil {
...
func UpdateTask(c *fiber.Ctx) error {
	...
	resp, err := (&services.DefaultTaskService{}).Update(c.Context(), c, task)
	if err != nil {
		return c.Status(fiber.StatusInternalServerError).JSON(core.Error(fiber.StatusInternalServerError, "internal error", err.Error(), nil))
	}
	return c.Status(resp.Code).JSON(resp)
...
func DeleteTask(c *fiber.Ctx) error {
	...
	resp, err := (&services.DefaultTaskService{}).Delete(c.Context(), c, req.ID)
	if err != nil {
		return c.Status(fiber.StatusInternalServerError).JSON(core.Error(fiber.StatusInternalServerError, "internal error", err.Error(), nil))
	}
	return c.Status(resp.Code).JSON(resp)
